  ...
  <div className="center-col">
    <div class=" posts-start">
      <div className="posts-bu">
        <div className="sp-pro-pic" onClick={togglePopup1}><img className="post-pro-pic" src={profilePicURL} alt="Los Angeles" width="20%" height="20%"/><button onClick={togglePopup}>Test</button> <Popup trigger={<button  className="button-sp">Strat a post</button>} position="center">
        {close => (
      ...
      <div className="post_popup">
        ...
        <div className="popup_uploaded"><img id="target" src={image}/></div>
        <div className="popup_icons"><input type="file" onchange={loadFile} id="myFile" name="filename"></input></div>
