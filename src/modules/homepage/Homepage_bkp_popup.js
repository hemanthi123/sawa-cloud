...
<div>
<div><a href="../homepage"><img src={home} className="icon-home" alt="logo" /></a></div>
...
<div className="home-su-welcome"><h4>Welcome to your social awareness network</h4> </div>


<div className="first_col_parent">
  <div className="div-categories" >
    ...
    <div className="prof-desc">
      <p>{name}</p>
      <p><a href="../hem">Edit your profile</a></p>
      <p><a href="../hem">View your recent posts</a></p>
      <p><a href="../posts_approval">Approve pending posts</a></p>
      <p><a href="../advertisements_approval">Approve pending advertisements</a></p> 
    </div>
  </div>
</div>
...
<div className="second_col_parent">
  <div className="center-col">
    <div class=" posts-start">
      <div className="posts-bu">
        <div className="sp-pro-pic"><img className="post-pro-pic" src={profilePicURL} alt="Los Angeles" width="20%" height="20%"/> <Popup trigger={<button className="button-sp">Strat a post</button>} position="right center">
    <div>wefwefwe<div className="Popup_post">Popup content here !!</div></div>
  </Popup></div>
      </div>
    </div>
...
<div className="third_col_parent">
